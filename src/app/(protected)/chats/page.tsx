          ...
          {filteredUsers.map((user) => (
            <li
              ...
              className={`p-2 mb-2 rounded cursor-pointer hover:bg-gray-600 ${
                selectedChat === user.id ? "bg-blue-800 text-white" : "bg-gray-700"
              }`}
          ...
          <div className="p-4 border-t border-gray-700 bg-gray-1000 flex items-center flex-shrink-0" style={{ height: "5em" }}>
            ...
            <input
                ...
                style={{
                  ...
                  color: 'white', // Makes sure text is visible on dark background
                  padding: '0 10px', // Optional: Adds some padding for better spacing
                }}
                className="focus:ring-0" // This removes the default focus ring if you are using Tailwind CSS
              />
