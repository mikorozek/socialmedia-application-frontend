        ...
        <div className="min-h-screen flex ">
            ...
            <div className="w-1/2 flex items-center justify-center">
                <div className="w-96 border border-customGray p-8 rounded-md shadow-md">
                    <h2 className="text-2xl font-bold mb-4 text-center">Sign in to Social Media Application</h2>
                    {errorMessage && (
                    ...
                    <p className="mt-4 text-center">
                        New to Social Media Application? <Link href="/register" className="text-blue-500 hover:text-blue-700">Sign up</Link>
                    </p>
                </div>
            </div>
    </div>
