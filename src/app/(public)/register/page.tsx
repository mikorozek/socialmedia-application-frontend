        ...
        <div className="min-h-screen flex">
            ...
            <div className="w-1/2 flex items-center justify-center">
                <div className="w-96 border border-customGray p-8 rounded-md shadow-md">
                    <h2 className="text-2xl font-bold mb-4 text-center">Sign up for Social Media Application</h2>
                    {errorMessage && (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label htmlFor="name" className="ml-1 block text-sm font-medium text-white">Username</label>
                            <input
                                type="text"
                                id="name"
                                value={username}
